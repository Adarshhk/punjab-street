...
<template>
  ...
  <div class="w-full h-full bg-[#141313]">
    <div class="flex flex-col  rounded-lg mx-0 mt-0">
      ...
      <div class="">
        <div v-if="showTableData && reorderedPlans.length">
          ...
          <!-- BEGIN: Page Layout -->
          <!-- for table  -->
          <template class="block mx-2">
            <div class="pt-2 px-[1px] rounded-lg flex flex-col justify-center bg-secondary ">
              <div class="">
                <div class=" py-4 px-2">
            <p class="text-2xl font-normal text-white">Strategies</p>
