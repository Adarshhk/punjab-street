  ...
  <div class="h-screen bg-third text-color">
    <div class="login-page relative h-full grid lg:grid-cols-2 gap-4">
      ...
      <div class="flex justify-center items-center px-4 lg:px-0">
        <div class="rounded-lg bg-third mx-2 sm:mx-4 p-4 w-full lg:w-auto">
          <div class="login-box min-w-[300px] sm:min-w-[500px] lg:min-w-[600px] bg-opacity-10 rounded-lg">
            <!-- Mobile logo -->
            <div class="visible lg:hidden flex justify-center my-5">
              <a
                class="flex justify-center items-center logo w-[249px] h-16 cursor-pointer"
                href="#"
              >
                <logoComp />
              </a>
            ...
            <div class="max-w-lg mx-auto p-6">
              <h1 class="text-4xl font-bold text-center dark:text-white text-gray-800 mb-4">Sign Up</h1>
              <p class="text-center dark:text-white text-gray-600 mb-4">Please enter your details.</p>
              ...
              <form @submit.prevent="verifyOtp" class="space-y-6">
                ...
                <div v-if="!otpAuthSignup" class="space-y-6">
                  ...
                  <div class="flex flex-col">
                    <label for="name" class="dark:text-white text-gray-700 mb-2">Full Name</label>
                    <input
                      id="name"
                      type="text"
                      name="name"
                  ...
                  <!-- Mobile No. -->
                  <div class="flex flex-col">
                    <label for="mobile" class="dark:text-white text-gray-700 mb-2">Mobile No.</label>
                    <input
                      id="mobile"
                      type="tel"
                      name="mobile"
                  ...
                  <div class="flex flex-col">
                    <label for="confirm_password" class="dark:text-white text-gray-700 mb-2">Confirm Password</label>
                    <div class="relative">
                      <input
                ...
                <div class="flex justify-start mt-6">
                  <div class="flex items-center">
                    ...
                    <label for="T&C" class="dark:text-white text-gray-700 whitespace-nowrap">
                      I agree to the&nbsp;
                      <a :href="tncUrl" target="_blank" class="text-blue-600 underline">T&C</a> and&nbsp;
                      <a :href="privacyPolicyUrl" target="_blank" class="text-blue-600 underline">Privacy Policy</a>
                    </label>
                  </div>
                </div>
